...
for (let i = 0; i < particleCount * 3; i += 3) {
    ...
    velocityArray[i] = (Math.random() - 0.5) * 0.0002; // reduced speed
    velocityArray[i + 1] = (Math.random() - 0.5) * 0.002; // reduced speed
    velocityArray[i + 2] = (Math.random() - 0.5) * 0.002; // reduced speed
